  ...
  QUnit.diff = function () {
    ...
    */
  	DiffMatchPatch.prototype.diffCompute = function (text1, text2, checklines, deadline) {
  		...
  		return this.diffdisect(text1, text2, deadline);
  	};
    ...
    * @private
    */
  	DiffMatchPatch.prototype.diffdisect = function (text1, text2, deadline) {
  				...
  				if (x1 > text1Length) {
  					...
  					if (k2Offset >= 0 && k2Offset < vLength && v2[k2Offset] !== -1) {
  						...
  						if (x1 >= x2) {
  							...
  							// Overlap detected.
  							return this.diffdisectSplit(text1, text2, x1, y1, deadline);
  						}
  					}
  				}
  			}
    ...
    * @private
    */
  	DiffMatchPatch.prototype.diffdisectSplit = function (text1, text2, x, y, deadline) {
