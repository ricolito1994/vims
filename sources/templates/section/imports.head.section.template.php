...
if (!isset ( $_SESSION ['PASSWORD'] ) && $current_page != 'login' ) header('Location: /vims/login');
		

if (isset ( $_SESSION ['PASSWORD'] ) && $current_page == 'login') 	header('Location: /vims');
...
?>
<title><?php ECHO isset($_SESSION['COMPANY_NAME']) ? $_SESSION['COMPANY_NAME'] : 'VIMS 1.0';  ?></title>
<meta charset="utf-8">
...
<!--<link rel="stylesheet" href="<?php echo $prefix;?>sources/imports/styles/font-awesome/css/font-awesome.bs.min.css<?php echo $ver; ?>" />-->
...
<link rel="stylesheet" href="<?php echo $prefix;?>sources/styles/marker.style.css<?php echo $ver; ?>" />
...
<script defer type="text/javascript" src="<?php echo $prefix;?>sources/imports/scripts/qrcodejs/qrcode.min.js<?php echo $ver; ?>" ></script>
<script defer type="text/javascript" src="<?php echo $prefix;?>sources/imports/scripts/qrcodescanner/html5-qrcode-master/minified/html5-qrcode.min.js<?php echo $ver; ?>" ></script>
...
<?php $ip_address = $ip_address == "127.0.0.1" ? "localhost" : $_SERVER['HTTP_HOST'];; ?>
var ipaddress = "<?php echo $ip_address == '::1' ? 'localhost' : $_SERVER['HTTP_HOST'];; ?>";
